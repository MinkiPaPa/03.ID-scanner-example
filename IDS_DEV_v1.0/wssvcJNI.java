...
//			System.out.println("saveStreamToBitmap:" + e.getMessage());
	...
	public static String setResultMessage(int resVal) {
		...
		switch (resVal) {
			case 0 :
				...
				break;
			case -1 :
				sResultMessage = "errorOffline";
				break;
			case -2 :
				sResultMessage = "errorInternal";
				break;
			case -3 :
				sResultMessage = "errorIo";
				break;
			case -4 :
				sResultMessage = "errorMemory";
				break;
			case -10 :
				sResultMessage = "errorSvcRun";
				break;
			case -12 :
				sResultMessage = "errorIpc";
				break;
			case -13 :
				sResultMessage = "errorApiLoad";
				break;
			case -14 :
				sResultMessage = "errorApiOpen";
				break;
			case 1 :
				sResultMessage = "errorBusy";
				break;
			case 2 :
				sResultMessage = "errorJam";
				break;
			case 3 :
				sResultMessage = "errorTimeout";
				break;
			case 10 :
				sResultMessage = "errorSessionId";
				break;
		}
